...
//
//   const AppBaseButton({Key? key, required this.onPressed, required this.buttonTitle, required this.status})
//       : super(key: key);
//
//   @override
...
//                 status == ButtonStatus.initial ? AppColor.grayNavy300 : AppColor.orangeE36847),
//             shape: MaterialStateProperty.all<RoundedRectangleBorder>(const RoundedRectangleBorder(
//               borderRadius: BorderRadius.zero,
//             ))),
//         onPressed: (status == ButtonStatus.initial)
//             ? null
//             : () {
//                 hideKeyboard();
